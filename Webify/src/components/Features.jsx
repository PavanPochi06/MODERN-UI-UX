...
const features = [
  {
    ...
    description: "Intelligent code suggestions powered by advanced AI",
    codeSnippet: `
  ...
  },
  {
    ...
    description: "Identify and fix bugs before they reach production",
    codeSnippet: `
     // AI suggest fix:
              ...
              <div className="flex-1 w-full">
                <div className="realtive group">
                  <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border-1 group-hover:border-blue-600/50 transition-all duration-300">
                    <div className="bg-red-950 rounded-lg p-3 sm:p-4 font-mono text-xs sm:text-sm">
