const testimonials = [
  ...
  },
  {
    ...
    role: "Tech Lead",
    image:
      "https://images.pexels.com/photos/415629/pexels-photo-415629.jpeg?auto=compress&cs=tinysrgb&w=200",
    content:
  ...
  },
  {
    ...
    content:
      "Our development velocity by 300% since adopting this platform. It's like havin g a senior developer pair programming with every team member.",
  },
];
          ...
          <div className="lg:w-1/2 w-full">
            <div className="space-y-6 sm:space-y-8">
              {testimonials.map((testimonial, key) => (
                <div
                  key={key}
                  className="bg-slate-900/50 p-4 sm:p-6 backdro-blur-sm border border-slate-800 rounded-xl sm:rounded-2xl"
                >
